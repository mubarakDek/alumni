...
export default function Contact() {
  return (
    <div>
      <h1 className="uppercase pt-10 text-xl text-gray-700 text-center">
        Contact us
      </h1>
      <div className="container p-12 md:p-16 sm:max-w-lg md:max-w-4xl lg:w-full mx-auto mt-10">
        <form>
          ...
          <div className="flex mt-4 justify-end">
            <button
              className="w-full md:w-auto shadow bg-primary hover:bg-secondary focus:shadow-outline focus:outline-none text-white py-2 px-8 rounded"
              type="button"
            >
              {" "}
              Sign in{" "}
